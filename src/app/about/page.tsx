...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/tubakhxn",
    content: "/naresh-khatri",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/tubakhxn",
    content: "/naresh-khatri",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Tuba Ahmed Khan</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Tuba, a Fullstack developer passionate about
            ...
            <p className="mb-10">
              When I&apos;m not coding, you can find me [Vlogging or creating content], exploring new technologies, or sipping coffee
